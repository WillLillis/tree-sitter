...
with ESM, as well as CommonJS in strict mode. If your grammar depends on npm to pull in dependencies,
the native runtime is compatible *after* running `npm install`.
